...
public class Program {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i < 11; i++) {
            ...
            switch (a) {
                case 0:
                    horde.add(new Magician(getName(), 1, i));
                    break;
                case 1:
                    horde.add(new Outlaw(getName(), 1, i));
                    break;
                case 2:
                    horde.add(new Crossbowman(getName(), 1, i));
                    break;
                case 3:
                    horde.add(new Peasant(getName(), 1, i));
                    break;
        ...
        for (int j = 1; j < 11; j++) {
            ...
            switch (n) {
                case 0:
                    people.add(new Monk(getName(), 10, j));
                    break;
                case 1:
                    people.add(new Spearman(getName(), 10, j));
                    break;
                case 2:
                    people.add(new Sniper(getName(), 10, j));
                    break;
                case 3:
                    people.add(new Peasant(getName(), 10, j));
                    break;
